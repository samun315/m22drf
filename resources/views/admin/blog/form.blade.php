            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('admin.blog.index') }}" class="btn btn-sm btn-light-success">
                ...
                <div class="card-body py-3">
                    ...
                    <form class="form" method="POST" enctype="multipart/form-data"
                          action="{{ isset($editModeData) ? route('admin.blog.update', $editModeData->id) : route('admin.blog.store') }}">
                        @csrf
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6 fv-row mb-5">
                                ...
                                <select name="category_name" data-control="select2" data-placeholder="Select Category"
                                    ...
                                    @foreach ($categories as $category)
                                        <option
                                            @isset($editModeData)
                                                {{ $editModeData->category_id == $category->id ? 'selected' : '' }}
                                            @endisset
                            ...
                            <div class="col-md-12 fv-row mb-5">
                                ...
                                <textarea class="form-control form-control-solid summernote2"
