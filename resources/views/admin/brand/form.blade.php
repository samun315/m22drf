...
@if (isset($editModeData))
    ...
    @section('toolbarTitle', 'Edit Brand')
@else
    @section('title', 'Create Brand')
    @section('toolbarTitle', 'Create Brand')
@endif
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('admin.brand.index') }}" class="btn btn-sm btn-light-success">
                ...
                <div class="card-body py-3">
                    ...
                    <form class="form" method="POST" enctype="multipart/form-data"
                        action="{{ isset($editModeData) ? route('admin.brand.update', $editModeData->id) : route('admin.brand.store') }}">
                        @csrf

                        @isset($editModeData)
                            @method('PUT')

                            <input type="text" hidden name="brand_id" value="{{ $editModeData->id }}">
                        @endisset
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6 fv-row mb-5">
                                ...
                                @isset($editModeData->image)
                                    <a target="_blank" href="{{ asset('uploads/brand/' . $editModeData->image) }}">View
                                        Image</a>
                                @endisset
