            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('admin.brand.create') }}" class="btn btn-sm btn-light-success">
                            <span class="svg-icon svg-icon-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img style="width: 80px; height: 80px; border-radius: 50%"
                                                src="{{ asset('uploads/brand/' . $value->image) }}" alt="">
                                        </td>
                                        <td> {{ $value->name }} </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.brand.edit', $value->id) }}"
...
@section('page_scripts')
    ...
    <script>
        function updateStatus(status, brand_id) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    Swal.fire({
                        position: 'top-end',
                        icon: 'success',
                        title: 'Brand status successfully updated.',
