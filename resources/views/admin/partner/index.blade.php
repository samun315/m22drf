...
@section('toolbarTitle', 'Manage Partner')
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('admin.partner.create') }}" class="btn btn-sm btn-light-success">
                            <span class="svg-icon svg-icon-2">
                        ...
                        <table class="table align-middle gs-0 gy-4">
                            ...
                            @foreach ($results as $value)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('admin.partner.edit', $value->id) }}"
                                               class="btn btn-primary btn-sm">
                                                Edit
                                            </a>
                                            <a href="{{ route('admin.partner.delete', $value->id) }}"
