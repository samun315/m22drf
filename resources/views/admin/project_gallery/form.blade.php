...
@if (isset($editModeData))
    ...
    @section('toolbarTitle', 'Edit Project Gallery')
@else
    @section('title', 'Create Project Gallery')
    @section('toolbarTitle', 'Create Project Gallery')
@endif
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('admin.project_gallery.index') }}" class="btn btn-sm btn-light-success">
                ...
                <div class="card-body py-3">
                    ...
                    <form class="form" method="POST" enctype="multipart/form-data"
                        action="{{ isset($editModeData) ? route('admin.project_gallery.update', $editModeData->id) : route('admin.project_gallery.store') }}">
                        @csrf

                        @isset($editModeData)
                            @method('PUT')

                            <input type="text" hidden name="project_gallery_id" value="{{ $editModeData->id }}">
                        @endisset
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6 fv-row mb-5">
                                ...
                                <select name="project_name" data-control="select2" data-placeholder="Select Project Name"
                                    class="form-select form-select-solid project_name">
                                    <option value="">Select project</option>
                                    @foreach ($projects as $project)
                                        <option
                                            @isset($editModeData)
                                                {{ $editModeData->project_id == $project->id ? 'selected' : '' }}
                                            @endisset
