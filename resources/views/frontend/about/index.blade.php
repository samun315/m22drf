            ...
            <div class="row">
                <div class="col-xl-7">
                    <div class="about-style2_content-box">
                        ...
                        <div class="sec-title">
                            ...
                            <h2>Educate Children In<br> Rural Areas Our Priority</h2>
                        </div>
                        <div class="inner-content">
                            <p>Laboris nisi utm aliquip sed duis aute lorem ipsum dolor sit amet consectetur
                                adipisicing elit sed do eiusmod tempor utm incididunts lorem ipsum sed labore sud
                                dolore magna aliqua.</p>
                            <ul>
                                <li>
                                    <div class="left">
                                        <div class="icon">
                                            <img src="assets/frontend/images/icon/world.png" alt="">
                                        </div>
                                        <div class="count-outer count-box style4">
                                            <span class="count-text" data-speed="3000"
                                                data-stop="1.3">1.3</span><span>K</span>
                                            <h5>Finished Projects</h5>
                                        </div>
                                    </div>
                                    <div class="right">
                                        <div class="text">
                                            <p>Nostrud temp exerction laboris<br> nisi utm aliquip duis aute.</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="style2">
                ...
                <div class="col-xl-5">
                    <div class="about-style2_image-box">
                        <img src="assets/frontend/images/resources/about-style2_image1.jpg" alt="">
                    </div>
                </div>
        ...
        <div class="auto-container">
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="single-fact-counter single-fact-counter-style2 wow slideInUp" data-wow-delay="200ms"
                ...
                <!--Start Single Fact Counter Style2-->
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="single-fact-counter single-fact-counter-style2 deep-gray wow slideInUp"
                ...
                <!--Start Single Fact Counter Style2-->
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="single-fact-counter single-fact-counter-style2 wow slideInUp" data-wow-delay="400ms"
                        data-wow-duration="1500ms">
                        <div class="outer-box">
                            <div class="shape1 wow zoomIn" data-wow-delay="0ms" data-wow-duration="3500ms">
                                <img class="zoom-fade" src="assets/frontend/images/shape/thm-shape-9.png" alt="">
