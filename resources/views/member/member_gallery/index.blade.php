...
@section('title', 'Manage Member Gallery')
@section('toolbarTitle', 'Manage Member Gallery')
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="svg-icon svg-icon-2">
                            ...
                            <span class="card-label fw-bolder fs-3 mb-1">Manage Member Gallery</span>
                        </span>
                    </h3>
                    <div class="card-toolbar">
                        <a href="{{ route('member.memberGallery.create') }}" class="btn btn-sm btn-light-success">
                            <span class="svg-icon svg-icon-2">
                        ...
                        <table class="table align-middle gs-0 gy-4">
                            ...
                            @foreach ($results as $value)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('member.memberGallery.edit', $value->id) }}"
...
@section('page_scripts')
    ...
    <script>
        function updateActiveStatus(status, id) {
            ...
            $.ajax({
                type: "PUT",
                url: "{{ route('member.memberGallery.update.status') }}",
                data: {
                    id: id,
                    status: status,
                    _token: v_token
