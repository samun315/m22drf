...
@section('toolbarTitle', 'User List')
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('user.create') }}" class="btn btn-sm btn-light-success">
                            <span class="svg-icon svg-icon-2">
                                            ...
                                            <label class="form-check form-switch form-check-custom form-check-solid">
                                                ...
                                                @if ($value->status == 'YES')
                                                    <input class="form-check-input"
                                                        onchange="updateUserStatus('NO', {{ $value->id }})"
                                                        name="status" type="checkbox" value="YES" checked="checked" />
                                                @else
                                                    <input class="form-check-input"
                                                        onchange="updateUserStatus('YES', {{ $value->id }})"
